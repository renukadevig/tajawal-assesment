...
public class CartPage extends TestBase {
	...
	@FindBy(xpath="//div[@class='sc-hARARD XoHkM']/div[2]")
	WebElement popup;
	...
	public CartPageResponseDTO.CartFeeData cartDetails()
	{
		CartPageResponseDTO cartPageResponseDTO=new CartPageResponseDTO();
		CartPageResponseDTO.CartFeeData cartFeeData=cartPageResponseDTO.new CartFeeData();
		...
		if(serviceFeeAmtNum==null || fareAmtNum==null) {
			System.out.println("Error. serviceFeeAmtNum & fareAmtNum incompactible");
			return null;
		}	
	...
	public void TravellerDetails(){
		...
		/*contactFirstName.sendKeys("Renuka");
		contactLastName.sendKeys("Gopal");*/
